...
1. **GitHub Security Advisories** (Preferred): Use [GitHub's private vulnerability reporting](https://github.com/benjaminch/sobriquet/security/advisories/new)
...
1. **Review aliases regularly**: Use `sobriquet audit` to check for accidentally committed secrets
