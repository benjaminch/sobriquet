...
1. **Main Repository** (`benjaminch/sobriquet`) - Contains the source code and release automation
...
class Alx < Formula
  ...
  homepage "https://github.com/benjaminch/sobriquetrs"
  license "MIT"

  on_macos do
    on_arm do
      url "https://github.com/benjaminch/sobriquetrs/releases/download/1.0.0/alx-1.0.0-aarch64-apple-darwin.tar.gz"
      sha256 "SHA256_HASH_HERE"
    end
    on_intel do
      url "https://github.com/benjaminch/sobriquetrs/releases/download/1.0.0/alx-1.0.0-x86_64-apple-darwin.tar.gz"
      sha256 "SHA256_HASH_HERE"
    end
  end
  ...
  on_linux do
    on_arm do
      url "https://github.com/benjaminch/sobriquetrs/releases/download/1.0.0/alx-1.0.0-armv7-unknown-linux-gnueabihf.tar.gz"
      sha256 "SHA256_HASH_HERE"
    end
    on_intel do
      url "https://github.com/benjaminch/sobriquetrs/releases/download/1.0.0/alx-1.0.0-x86_64-unknown-linux-musl.tar.gz"
      sha256 "SHA256_HASH_HERE"
    end
  end
...
class Alx < Formula
  ...
  on_macos do
    on_arm do
      url "https://github.com/benjaminch/sobriquetrs/releases/download/$VERSION/alx-$VERSION-aarch64-apple-darwin.tar.gz"
      sha256 "$AARCH64_DARWIN"
    end
    on_intel do
      url "https://github.com/benjaminch/sobriquetrs/releases/download/$VERSION/alx-$VERSION-x86_64-apple-darwin.tar.gz"
  ...
  on_linux do
    on_arm do
      url "https://github.com/benjaminch/sobriquetrs/releases/download/$VERSION/alx-$VERSION-armv7-unknown-linux-gnueabihf.tar.gz"
      sha256 "$ARMV7_LINUX"
    end
    on_intel do
      url "https://github.com/benjaminch/sobriquetrs/releases/download/$VERSION/alx-$VERSION-x86_64-unknown-linux-musl.tar.gz"
      sha256 "$X86_64_LINUX"
    end
  end
...
In the main `benjaminch/sobriquet` repository:
